...
function addFavorite(gistEntry) {
    ...
    var tmp = { 'id': gistEntry['id'], 'addr': 'https://api.github.com/gists/' + gistEntry['id'], 'description': description }; //local storage  via JSON format; adapted from solution and discussion found at http://stackoverflow.com/questions/23728626/localstorage-and-json-stringify-json-parse, particularly the top answer
